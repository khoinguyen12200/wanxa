...
function _callee(req, res) {
  var id, _req$headers, storeid, userid, privileges, accepted, deleteRes;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 6;
          return regeneratorRuntime.awrap((0, _connection["default"])("delete from `store-table`  WHERE id=?", [id]));
