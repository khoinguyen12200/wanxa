...
function _callee(req, res) {
  var _req$body, name, id, _req$headers, storeid, privileges, userid, accepted, updateRes;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 6;
          return regeneratorRuntime.awrap((0, _connection["default"])("UPDATE `store-table-group` SET `name`=? WHERE id =?", [name, id]));
