...
function _callee(req, res) {
  var _req$body, name, groupid, _req$headers, storeid, userid, privileges, accepted, addRes;

  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, name = _req$body.name, groupid = _req$body.groupid;
          ...
          _context.next = 6;
          return regeneratorRuntime.awrap((0, _connection["default"])("INSERT INTO `store-table`(`groupid`, `name`) VALUES (?,?)", [groupid, name]));
