...
function _callee(req, res) {
  var groupid, _req$headers, storeid, privileges, userid, accepted, delRes;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 6;
          return regeneratorRuntime.awrap((0, _connection["default"])("DELETE FROM `store-table-group` where id = ?", [groupid]));
