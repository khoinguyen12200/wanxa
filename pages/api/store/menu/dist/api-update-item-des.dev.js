...
function _callee(req, res) {
  var _req$body, id, des, groupid, _req$headers, privileges, userid, storeid, checked, udpateRes;

  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, id = _req$body.id, des = _req$body.des, groupid = _req$body.groupid;
          ...
          _context.next = 6;
          return regeneratorRuntime.awrap((0, _connection["default"])("update `menu-item` set des = ? where id = ?", [des, id]));
